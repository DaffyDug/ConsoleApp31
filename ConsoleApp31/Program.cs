...
using System.Text;
using static StringBuilderManeger;
...
namespace ConsoleApp22
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                stringBuilder.AppendLine($"{i + 1} - {actions[i].Descreption}");
            }
            while (true)
            {
...
{
    public string Descreption => "ввод текста";
    ...
    public void Run()
    {
        ...
        if (InputHelper.Input("", (int)modes[0], (int)modes[modes.Count], out int intvalue))
        {
            ...
            StringBuilderManeger.Instacne.ADDContent(Console.ReadLine(), (LineMode)intvalue);
        }
    }
...
{
    public string Descreption => "вывод информации";

    public void Run()
    {
        if (StringBuilderManeger.Instacne.ConteinsInfo())
        {
            StringBuilderManeger.Instacne.PrintInfo();
        }
    }
}
...
public class StringBuilderManeger
{
    private readonly StringBuilder stringBuilder = new StringBuilder();
    public static StringBuilderManeger Instacne;
    static StringBuilderManeger()
    {
        Instacne = new StringBuilderManeger();
    }
    private StringBuilderManeger()
    {
